...
// Яхьяев Данис ДИНРБ-21 Вариант 18 Лабораторная работа №4
// 18. Главное меню содержит раздел "Фигуры" с зависимым списком имен геометрических фигур.
// При выборе имени должна быть отображена только эта фигура и отмечено кружочком только это имя.
